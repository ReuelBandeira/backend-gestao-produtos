...
export class CreateViewListOrderProductLastHour1684171348626 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`create or replace
    algorithm = UNDEFINED view vw_list_order_product_hour as
    select
        l.id AS id_line,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP VIEW IF EXISTS vw_list_order_product_hour`);
  }
}
