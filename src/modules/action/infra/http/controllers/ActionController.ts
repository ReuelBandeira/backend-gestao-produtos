...
import CreateActionService from '@modules/action/services/CreateActionService';
import UpdateActionService from '@modules/action/services/UpdateActionService';
import DeleteActionService from '@modules/action/services/DeleteActionService';
import ActionRepository from '../../typeorm/repositories/ActionRepository';
...
export default class ActionController {
  ...
  public async findActions(request: Request, response: Response): Promise<Response> {
    ...
    const type_actions = await actions.findAllTypeFeeder();
